...
class JenisTabunganController extends Controller
{
    ...
    public function destroy(Request $request, $id)
    {
		...
		if($dataTabungan == null){
			...
			Session::flash("flash_notification", [
				"level" => "warning",
				"icon" => "fa fa-check",
				"message" => "Gagal! Data ".$jenisTab->nama." digunakan dalam tabel Tabungan!",
			]);
		}
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash("flash_notification", [
            "level" => "success",
            "icon" => "fa fa-check",
            "message" => "Tabungan ".$data->nama." berhasil diperbarui!"
        ]);
        return redirect()->route('jenistabungan.index');
    }    
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("flash_notification", [
            "level" => "success",
            "icon" => "fa fa-check",
            "message" => "Tabungan ".$request->nama." berhasil ditambahkan!"
        ]);
        return redirect()->route('jenistabungan.index');
    }
}
